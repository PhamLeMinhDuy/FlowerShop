    ...
    return (
      <div className='order-list'>
        <div className="order__container">
          <h2 className="order__container-title">ORDER LIST</h2>
          <div className='order'>
          <table className="order__container-table" border="1">
            <tbody>
              <tr className="order__container-table-titlerow">
                <th>ID</th>
                <th>Creation date</th>
                <th>Cust.name</th>
                <th>Cust.phone</th>
        ...
        {this.state.order ?
          <div className="order__container">
            <h2 className="order__container-title">ORDER DETAIL</h2>
            <div className='order'>
            <table className="order__container-table" border="1">
              <tbody>
                <tr className="order__container-table-titlerow">
